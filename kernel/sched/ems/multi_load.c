...
static __read_mostly u64 boost_interval = 16 * NSEC_PER_MSEC;   // 16
   	}
if (policy->cpu == 4) {
   	static __read_mostly unsigned int part_policy_idx = PART_POLICY_MAX_RECENT_LAST;
...
static __read_mostly u64 boost_interval = 14 * NSEC_PER_MSEC;   // 16
   	}
if (policy->cpu == 6) {
   	static __read_mostly unsigned int part_policy_idx = PART_POLICY_MAX_RECENT_LAST;
   	__read_mostly u64 period_size = 48/10 * NSEC_PER_MSEC;
...
static __read_mostly u64 boost_interval = 12 * NSEC_PER_MSEC;   // 16
   	}
#else
static __read_mostly unsigned int part_policy_idx = PART_POLICY_MAX_RECENT_LAST;
