...
sleep 3
    ...
    # BIG Cluster
    echo "25000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_0_temp  # 20000
    ...
    # MID Cluster
    echo "25000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_0_temp  # 20000
    ...
    # LITTLE Cluster
    echo "25000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_0_temp  # 20000
    ...
    echo "105000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_6_temp  # 115000
    ...
    echo "300" > /sys/devices/virtual/thermal/thermal_zone1/sustainable_power   # 500 CPU4
    echo "800" > /sys/devices/virtual/thermal/thermal_zone0/sustainable_power   # 1000 CPU6
