#!/system/bin/sh
# 
# Init TSKernel - PERFORMANCE PROFILE
#
...
sleep 3
	...
	echo " " >> $LOG;
    echo "## -- Initial PERFORMANCE Profile by ThundeRStormS" >> $LOG;
    ...
    echo "3016000" > /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq
    # BOOST CPU
    echo "1" > /sys/module/cpu_boost/parameters/sched_boost_on_input
    echo "120" > /sys/module/cpu_boost/parameters/input_boost_ms # 40
