#!/system/bin/sh
# 
# Init TSKernel - BALANCED PROFILE
#
...
sleep 3
	...
	echo " " >> $LOG;
    echo "## -- Initial BALANCED Profile by ThundeRStormS" >> $LOG;
    ...
    echo "96" > /sys/devices/platform/18500000.mali/highspeed_load
    ...
    echo "64" > /sys/block/sda/queue/nr_requests   # 128
    echo "64" > /sys/block/mmcblk0/queue/nr_requests   # 128
    ...
    echo "12000000" > /proc/sys/kernel/sched_wakeup_granularity_ns # 2000000
    echo "400000" > /proc/sys/kernel/sched_latency_ns # 10000000
    echo "4000000" > /proc/sys/kernel/sched_min_granularity_ns # 950000
