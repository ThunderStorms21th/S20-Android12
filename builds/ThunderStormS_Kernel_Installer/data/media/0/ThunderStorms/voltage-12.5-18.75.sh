...
sleep 5
    ...
    # Voltage MIF : id 0,  -18750uV
    echo '0 2730000 781250' > /sys/power/dvfs_table # 800000
    echo '0 2535000 762500' > /sys/power/dvfs_table # 781250
    echo '0 2288000 750000' > /sys/power/dvfs_table # 768750
    echo '0 2028000 743750' > /sys/power/dvfs_table # 762500
    echo '0 1716000 700000' > /sys/power/dvfs_table # 718750
    echo '0 1539000 656250' > /sys/power/dvfs_table # 675000
    echo '0 1352000 631250' > /sys/power/dvfs_table # 650000
    echo '0 1014000 581250' > /sys/power/dvfs_table # 600000
    echo '0 845000 550000' > /sys/power/dvfs_table # 568750
    echo '0 676000 537500' > /sys/power/dvfs_table # 556250
