...
sleep 5
    ...
    echo "80000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_2_temp  # 83000
    ...
    echo "93000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_4_temp  # 100000
    ...
    echo "100000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_6_temp  # 110000
    echo "6000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_6_hyst   # 5000
    echo "105000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_7_temp  # 115000
    ...
    echo "80000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_2_temp  # 83000
    ...
    echo "93000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_4_temp  # 100000
    ...
    echo "100000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_6_temp  # 110000
    echo "5000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_6_hyst   # 5000
    echo "105000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_7_temp  # 115000
    ...
    echo "102000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_6_temp  # 110000
    echo "5000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_6_hyst   # 5000
    echo "105000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_7_temp  # 115000
    ...
    echo "100000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_4_temp  # 110000
    echo "5000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_4_hyst   # 5000
    echo "105000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_5_temp  # 115000
    echo "5000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_5_hyst   # 5000
    echo "108000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_6_temp  # 115000
