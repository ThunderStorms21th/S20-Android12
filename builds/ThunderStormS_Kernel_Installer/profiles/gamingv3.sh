...
sleep 3
    ...
    echo "10000000" > /proc/sys/kernel/sched_wakeup_granularity_ns # 2000000
    ...
    echo "15" > /proc/sys/kernel/sched_rr_timeslice_ms  # 3
    ...
    echo "20" > /proc/sys/kernel/perf_cpu_time_max_percent  # 25
    echo "100000" > /proc/sys/kernel/perf_event_max_sample_rate # 100000
    echo "565" > /proc/sys/kernel/perf_event_mlock_kb  # 516 565
