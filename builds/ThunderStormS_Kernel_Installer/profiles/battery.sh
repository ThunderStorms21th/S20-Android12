#!/system/bin/sh
# 
# Init TSKernel - BAATTERY PROFILE
#
...
sleep 3
	...
	echo " " >> $LOG;
    echo "## -- Initial BATTERY Profile by ThundeRStormS" >> $LOG;
    ...
    echo "2522000" > /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq
    # BOOST CPU
    ...
    echo "40" > /proc/sys/fs/lease-break-time
    ...
    echo "8" > /sys/block/zram0/max_comp_streams    # 8, 1
    ...
    echo "98" > /sys/devices/platform/18500000.mali/highspeed_load
    ...
    echo "32" > /sys/block/sda/queue/nr_requests   # 128
    echo "32" > /sys/block/mmcblk0/queue/nr_requests   # 128
    ...
    echo "10" > /proc/sys/kernel/sched_rr_timeslice_ms  # 3
    echo "50" > /proc/sys/kernel/sched_nr_migrate # 0, 64
   ...
   # MID Cluster
   echo "power_allocator" > /sys/devices/virtual/thermal/thermal_zone1/policy
   # LITTLE Cluster
   echo "power_allocator" > /sys/devices/virtual/thermal/thermal_zone2/policy
   # GPU
   echo "power_allocator" > /sys/devices/virtual/thermal/thermal_zone3/policy
   # ISP
   echo "power_allocator" > /sys/devices/virtual/thermal/thermal_zone4/policy
   # NPU
   echo "power_allocator" > /sys/devices/virtual/thermal/thermal_zone5/policy
   # AC
   echo "power_allocator" > /sys/devices/virtual/thermal/thermal_zone6/policy
   # BATTERY
