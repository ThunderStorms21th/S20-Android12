...
sleep 5
    ...
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_6_temp  # 110000
    ...
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_6_temp  # 110000
    ...
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_5_temp  # 105000
    ...
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_4_temp  # 110000
    ...
    echo "107000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_7_temp  # 115000
