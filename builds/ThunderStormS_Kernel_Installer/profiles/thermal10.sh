...
sleep 3
    ...
    echo "112000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_7_temp  # 115000
    ...
    echo "83000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_2_temp  # 83000
    ...
    echo "110000" > /sys/devices/virtual/thermal/thermal_zone3/trip_point_6_temp  # 115000
