...
sleep 5
    ...
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone0/trip_point_5_temp  # 105000
    ...
    echo "95000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_4_temp  # 100000
    echo "5000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_4_hyst   # 5000
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone1/trip_point_5_temp  # 105000
    ...
    echo "85000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_1_temp  # 76000
    echo "3000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_1_hyst   # 2000
    echo "90000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_2_temp  # 83000
    echo "8000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_2_hyst   # 5000
    echo "97000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_3_temp  # 95000
    ...
    echo "100000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_6_temp  # 110000
    echo "5000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_6_hyst   # 5000
    echo "102000" > /sys/devices/virtual/thermal/thermal_zone2/trip_point_7_temp  # 115000
